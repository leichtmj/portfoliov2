  ...
  <div class="menu-inner">
    <ul class="menu-nav">
      <li class="menu-nav-item"><router-link class="menu-nav-link" to="/about"><span class="divitemenu">
          ...
          <li class="menu-nav-item"><button class="menu-nav-link" ><span class="divitemenu">
            <div>{{$t("nav.projects")}}</div>
          </span></button></li>
      <li class="menu-nav-item"><router-link class="menu-nav-link" to="/"><span class="divitemenu">
    ...
    <div class="gallery">
      <div class="title">
        ...
        <p class="mt-8">{{ $t('nav.discovery') }}</p>
      </div>
      <div class="images">
        <router-link class="image-link" to="/projects">
          <div class="image" data-label="Projet universitaire"><img src="https://imgur.com/U30rNFW.png" alt=""></div>
        </router-link>
        <router-link class="image-link" to="/projects">
          <div class="image" data-label="Bénévolat"><img src="https://imgur.com/T8nR2pG.png" alt=""></div>
        </router-link>
        <router-link class="image-link" to="/projects">
          <div class="image" data-label="Stage en entreprise"><img src="https://imgur.com/JL1vjyP.png" alt=""></div>
        </router-link>
        <router-link class="image-link" to="/projects">
          <div class="image" data-label="Projet web"><img src="https://imgur.com/QEknUuq.png" alt=""></div>
        </router-link>
      </div>
    </div>
  </div>
                  ...
                  <div class="ag-timeline-card_box">
                    <div v-show="index % 2 === 0">
                      ...
                      <div class="ag-timeline-card_meta-box">
                        <div class="ag-timeline-card_meta">{{ $rt(p.nameProject) }}</div>
                      </div>
                    </div>
                    <div v-show="index % 2 != 0">
                      <div class="ag-timeline-card_meta-box">
                  ...
                  <div class="ag-timeline-card_item">
                    <div class="ag-timeline-card_inner">
                      ...
                      <div class="ag-timeline-card_info">
                        <div class="ag-timeline-card_title">{{ $rt(p.nameProject) }}</div>
                        <div class="ag-timeline-card_desc">
                          {{ $rt(p.description) }}
                        </div>
                        <div class="tagsdiv">
                          <span v-for="(t, index) in p.tags"><a class="tags" target="_blank" :href="t.src">{{ t.title }}</a></span>
                        </div>
                      </div>
                    </div>
...
import cvfr from '@/assets/CVs/LEICHTMANN_JIMMY_CV_FR.pdf'
import cven from '@/assets/CVs/LEICHTMANN_JIMMY_CV_EN.pdf'
import svg from '@/assets/skills/php.svg'
